...
const registerDriver = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const user = req.user;
    const registeredDriver = yield driver_service_1.driverService.registerDriver(user.userId, req.body);
...
const updateDriver = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const updatedDriver = yield driver_service_1.driverService.updateDriver(userId, req.body);
    (0, sendResponse_1.sendResponse)(res, {
